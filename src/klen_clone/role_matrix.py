...
ROLE_MATRIX = {
    "administrator": {"enterprise.setup", "enterprise.approve", "user.manage", "role.manage", "access.review", "audit.read", "clone.read", "migration.review", "hrm.read", "hrm.manage", "hrm.lifecycle.prepare", "hrm.lifecycle.approve", "pos.manage", "pos.sale", "cash.close.prepare", "van.read", "van.route.prepare", "van.shift", "van.sale", "van.return", "van.offline_sync", "van.close.prepare", "crm.read", "crm.lead.prepare", "crm.activity.prepare", "crm.proposal.prepare"},
    ...
    "warehouse_supervisor": {"warehouse.receive", "warehouse.transfer.approve", "stock.adjust.approve", "inventory.approve", "inventory.rehearse", "delivery.allocate", "delivery.pick"},
    "van_user": {"van.shift", "van.sale", "van.return", "van.offline_sync", "draft.create", "draft.edit", "draft.submit", "draft.cancel"},
    ...
    "inventory_controller": {"stock.count", "stock.adjust.prepare", "stock.transfer.prepare", "inventory.create", "inventory.edit", "inventory.submit", "inventory.cancel"},
    "quality_controller": {"quarantine.manage", "recall.manage", "disposal.prepare", "goods_receipt.accept", "goods_receipt.reject", "goods_receipt.rehearse"},
